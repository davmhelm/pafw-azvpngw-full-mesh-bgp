...
# 1.1 Resource Group
echo -e "*** Creating local site - resource group $localSite_rg in $localSite_region"
az group create --name $localSite_rg --location $localSite_region --output none

# 1.2 Deploy Networking
# Create Virtual Network
echo -e "*** Creating local site - base networking in $localSite_region"
...
# Create Route Tables
echo -e "*** Creating local site - route tables for networking in $localSite_region"
...
echo -e "*** Creating local site - network security groups for networking in $localSite_region"
...
echo -e "*** Creating local site - Palo Alto Firewalls in $localSite_region"
...
az network nic create --name $localSite_fw1_name-eth2-trust-nic --resource-group $localSite_rg --vnet-name $localSite_vnet_name --subnet PA-Trust-Subnet --private-ip-address $localSite_fw1_staticIp_trust --ip-forwarding true --output none
...
az network nic create --name $localSite_fw2_name-eth2-trust-nic --resource-group $localSite_rg --vnet-name $localSite_vnet_name --subnet PA-Trust-Subnet --private-ip-address $localSite_fw2_staticIp_trust --ip-forwarding true --output none
...
echo -e "*** Creating local site - client VMs in $localSite_region"
# Create network interfaces
...
echo -e "*** Creating local site - route server in $localSite_region *** CAN TAKE UP TO 20 MINUTES ***"
# Create public IP
...
# 2.1 Resource Group
echo -e "*** Creating cloud site - resource group $cloudSite_rg in $cloudSite_region"
az group create --name $cloudSite_rg --location $cloudSite_region --output none

# 2.2 Deploy Networking
# Create Virtual Networks
echo -e "*** Creating cloud site - base networking in $cloudSite_region"
...
# Create Route Table
echo -e "*** Creating cloud site - route tables for networking in $cloudSite_region"
...
echo -e "*** Creating cloud site - VPN gateway in $cloudSite_region -- *** CAN TAKE UP TO 45 MINUTES ***"
# Create public IPs 
...
echo -e "*** Creating cloud site - vnet peerings in $cloudSite_region"
...
echo -e "*** Creating cloud site - VPN connections to local site Palo Alto Firewalls in $cloudSite_region"
...
echo -e "*** Updating local site - network security group for Palo Alto Firewall Untrust interfaces in $localSite_region"
...
echo -e "*** Creating cloud site - client VMs in $cloudSite_region"
# Create network interfaces
...
echo -e "*** Creating helper resources - bastion in $cloudSite_region *** CAN TAKE UP TO 10 MINUTES"
# Azure Bastion
...
echo -e "*** Creating helper resources - boot diagnostics storage accounts in $localSite_region and $cloudSite_region"
...
echo -e "*** Creating helper resources - enabling boot diagnostics for VMs in $localSite_rg and $cloudSite_rg"
...
echo -e "*** Creating helper resources - enabling auto-shutdown schedules for VMs in $localSite_rg and $cloudSite_rg"
...
# Install Configs
echo -e "*** ACTION REQUIRED: Install pafw XML config files on firewalls"
echo -e ""
...
echo -e ""
echo -e "*** Automated deployment complete."
...
Simply delete the resource groups created by lab-deploy.azcli script.

```bash
az group delete $localSite_rg
az group delete $cloudSite_rg
```
